...
def _infer_semantic_action_from_capture(acao: str, label: str, seletor: str, tag: str, valor_input: str = "") -> str:
...
def _infer_business_entity_from_capture(label: str, seletor: str, tag: str, contexto_tela: str = "") -> str:
...
def _infer_pattern_from_capture(acao: str, label: str, seletor: str, tag: str, capture_scope: str) -> str:
...
def _is_noise_event(label: str, seletor: str, acao: str, tag: str, capture_scope: str, valor_input: str = "") -> bool:
...
def _montar_evento_shadow(*,
    ...
    semantic_action = _infer_semantic_action_from_capture(acao, label, dados.get("seletor", ""), dados.get("tag", ""), valor_input)
    business_entity = _infer_business_entity_from_capture(label, dados.get("seletor", ""), dados.get("tag", ""), analise.get("contexto_tela", ""))
...
def _salvar_shadow_jsonl(nome_aula: str, objetivo_aula: str, eventos: list[dict]) -> str | None:
    try:
