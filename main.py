...
# ==============================================================
# 🧠 RESOLVEDOR SEMÂNTICO (AGORA COM BUSCA POR PLACEHOLDER)
# ==============================================================
async def resolver_alvo_semantico(page, alvo):
    def construir_locator(contexto):
        if "role" in alvo:
            ...
            # 🚀 NOVO: Foco exclusivo em campos de texto reais ignorando ícones!
...
async def holofote_e_clique(locator, cor_neon="#2596be"):
    ...
    async with async_playwright() as p:
        ...
        for passo in roteiro["passos"]:
            ...
            if acao == "clique":
                ...
                await holofote_e_clique(locator)
                ...
                await safe_evaluate(locator, "el => el.style.outline = '4px solid #2596be'")
                await safe_evaluate(locator, "el => el.style.boxShadow = '0 0 25px #2596be'")
